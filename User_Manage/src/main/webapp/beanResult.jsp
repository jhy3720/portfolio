...
<%@ page import="java.util. *"%> <%@ page import="studpkg. StudDTO"%> 
...
.button_form { width:60px; margin-left:5px; } .fset {padding: 15px; } #dupBtn { height:25px;} 
ul.level_1 > li {list-style:none; display:inline-block;vertical-align:bottom;} 
ul.level_1 > li > ul {list-style:none; } level_2 li { padding-top:5px; } 
...
table {width:100%; height:80%; } th, td { text-align:center; padding: 10px; vertical-align:bottom;} 
